...
plot_b1 <- fviz_famd(famd_b, axes = c(1,2), 
          geom= "text",
          repel = T,
          habillage = c("type"),
...
plot_b2 <- fviz_famd(famd_b, axes = c(1,2), 
                    geom= "text",
                    repel = T,
...
#Plot Axis1 and Axis2
plot_f1 <- fviz_famd(famd_f, axes = c(1,2), 
                    geom= "text", 
                    repel = T,
                    habillage = c("type"),
                    legend.title = "Carcass treatment",
...
plot_f2 <- fviz_famd(famd_f, axes = c(1,2), 
                     geom= "text", 
                     repel = T,
                     habillage = c("sample_time"),
                     legend.title = "Sampling period",
...
# plot_v3 <- fviz_famd(famd_v, axes = c(1,2), 
#                     geom= "text", 
#                     repel = T,
#                     habillage = c("type", "species"),
#                     legend.title = "Carcass treatment and species",
#                     addEllipses = T, ellipse.type = "confidence",
#                     alpha.ind = 0.7, #transparency
#                     col.ind = "black",
#                     fontsize = 7,
#                     col.quali.var = "darkblue")+
#                     labs(title = "Vertebrate scavenging events FAMD, 95% CI ellipses around centroids for sampling period",
#                          x = "Axis 1 (18.3%)",
#                          y = "Axis 2 (17.0%)"
#                     )+
...
famd_plots_invert <- ggarrange(plot_b1, plot_b2, plot_f1, plot_f2,
                               labels = "AUTO",
                                 ncol = 2,
                                 nrow = 2,
                                 align = "v")
